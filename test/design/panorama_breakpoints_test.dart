...
void main() {
  group('PanoramaLayoutClass.fromWidth', () {
    test('classifies phone-width layouts as compact', () {
      expect(PanoramaLayoutClass.fromWidth(360), PanoramaLayoutClass.compact);
      expect(PanoramaLayoutClass.fromWidth(599), PanoramaLayoutClass.compact);
    });
    ...
    test('classifies tablet/small-window layouts as medium', () {
      ...
      expect(PanoramaLayoutClass.fromWidth(1023), PanoramaLayoutClass.medium);
    });

    test('classifies desktop-width layouts as expanded', () {
      expect(PanoramaLayoutClass.fromWidth(1024), PanoramaLayoutClass.expanded);
      expect(PanoramaLayoutClass.fromWidth(1920), PanoramaLayoutClass.expanded);
    });
  });
}
