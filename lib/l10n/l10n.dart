...
class AppLocalizations {
  ...
  /// `Overview`
  String get dashboardOverviewEyebrow {
    return Intl.message(
      'Overview',
      name: 'dashboardOverviewEyebrow',
      desc: '',
      args: [],
    );
  }
  ...
  String get dashboardOverviewSubtitle {
    return Intl.message(
      'Your traffic is routed through Panorama and your real IP is hidden.',
      name: 'dashboardOverviewSubtitle',
      desc: '',
      args: [],
    );
  }
  ...
  String get dashboardOverviewTagline {
    return Intl.message(
      'A more private, open internet.',
      name: 'dashboardOverviewTagline',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Active profile`
  String get dashboardActiveProfile {
    return Intl.message(
      'Active profile',
      name: 'dashboardActiveProfile',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Network traffic`
  String get dashboardNetworkTraffic {
    return Intl.message(
      'Network traffic',
      name: 'dashboardNetworkTraffic',
      desc: '',
      args: [],
    );
  }
  ...
  String get dashboardRoute {
    return Intl.message('Route', name: 'dashboardRoute', desc: '', args: []);
  }

  /// `Change route`
  String get dashboardChangeRoute {
    return Intl.message(
      'Change route',
      name: 'dashboardChangeRoute',
      desc: '',
      args: [],
    );
  }
  ...
  String get dashboardChangeRouteDesc {
    return Intl.message(
      'Switch to a different profile or proxy route.',
      name: 'dashboardChangeRouteDesc',
      desc: '',
      args: [],
    );
  }
  ...
  String get dashboardStatusDescription {
    return Intl.message(
      'Your traffic is private and secured',
      name: 'dashboardStatusDescription',
      desc: '',
      args: [],
    );
  }
  ...
  String get dashboardUptime {
    return Intl.message('Uptime', name: 'dashboardUptime', desc: '', args: []);
  }

  /// `Last 30 minutes`
  String get dashboardLastThirtyMinutes {
    return Intl.message(
      'Last 30 minutes',
      name: 'dashboardLastThirtyMinutes',
      desc: '',
      args: [],
    );
  }
