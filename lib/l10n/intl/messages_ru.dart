...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(time) => "Проверено ${time}";
  ...
  static String m10(date) => "Истекает ${date}";

  static String m11(name) => "${name} пропущено";
  ...
  static String m20(reason) => "Последняя попытка не удалась: ${reason}";

  static String m21(time) => "Последний раз: ${time}";
  ...
  static String m27(count) =>
      "${Intl.plural(count, zero: 'Пауза', one: 'Пауза · ${count} новая строка', few: 'Пауза · ${count} новые строки', many: 'Пауза · ${count} новых строк', other: 'Пауза · ${count} новой строки')}";
  ...
  static String m31(available, total) => "Доступно ${available} из ${total}";

  static String m32(value) => "Только «${value}»";

  static String m33(name) => "Узел: ${name}";

  static String m34(name) => "Профиль: ${name}";

  static String m35(time) => "Обновлено ${time}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "backupErrorFailed": MessageLookupByLibrary.simpleMessage(
      "неизвестная ошибка",
    ),
    "backupErrorNotFound": MessageLookupByLibrary.simpleMessage(
      "на сервере нет файла резервной копии",
    ),
    "backupErrorServer": MessageLookupByLibrary.simpleMessage("ошибка сервера"),
    "backupErrorUnauthorized": MessageLookupByLibrary.simpleMessage(
      "вход отклонён",
    ),
    ...
    "categoryAi": MessageLookupByLibrary.simpleMessage("ИИ"),
    "categoryConnectivity": MessageLookupByLibrary.simpleMessage("Связность"),
    "categoryRegional": MessageLookupByLibrary.simpleMessage("Региональные"),
    "categorySocial": MessageLookupByLibrary.simpleMessage("Соцсети"),
    "categoryStreaming": MessageLookupByLibrary.simpleMessage("Стриминг"),
    "checkAll": MessageLookupByLibrary.simpleMessage("Проверить все"),
    "checkService": MessageLookupByLibrary.simpleMessage("Проверить"),
    ...
    "connectionEthernet": MessageLookupByLibrary.simpleMessage("Ethernet"),
    "connectionMobile": MessageLookupByLibrary.simpleMessage("Мобильная сеть"),
    ...
    "copyAll": MessageLookupByLibrary.simpleMessage("Копировать всё"),
    ...
    "coreStopped": MessageLookupByLibrary.simpleMessage("Ядро остановлено"),
    ...
    "currentNode": MessageLookupByLibrary.simpleMessage("Узел"),
    "custom": MessageLookupByLibrary.simpleMessage("Пользовательский"),
    "cut": MessageLookupByLibrary.simpleMessage("Вырезать"),
    "dark": MessageLookupByLibrary.simpleMessage("Темный"),
    "dashboard": MessageLookupByLibrary.simpleMessage("Панель управления"),
    "dashboardDesc": MessageLookupByLibrary.simpleMessage(
      "Настраиваемые виджеты из прежних версий",
    ),
    ...
    "davChecking": MessageLookupByLibrary.simpleMessage("Проверка…"),
    "davReachable": MessageLookupByLibrary.simpleMessage("Доступен"),
    "davUnreachable": MessageLookupByLibrary.simpleMessage("Нет соединения"),
    "daysAgo": m2,
    ...
    "dnsConfigNote": MessageLookupByLibrary.simpleMessage(
      "Это настройки DNS, с которыми работает ядро. Какой резолвер отвечает на самом деле, здесь не проверяется.",
    ),
    "dnsConfiguredBy": MessageLookupByLibrary.simpleMessage(
      "Источник настроек",
    ),
    ...
    "dnsFromFallback": MessageLookupByLibrary.simpleMessage(
      "Настройки DNS приложения и системный резолвер (в профиле DNS выключен)",
    ),
    "dnsFromOverride": MessageLookupByLibrary.simpleMessage(
      "Настройки DNS приложения (переопределение включено)",
    ),
    "dnsFromProfile": MessageLookupByLibrary.simpleMessage("Профиль"),
    ...
    "interfaces": MessageLookupByLibrary.simpleMessage("Интерфейсы"),
    ...
    "localAddresses": MessageLookupByLibrary.simpleMessage("Локальные адреса"),
    ...
    "networkIdentity": MessageLookupByLibrary.simpleMessage(
      "Сетевая идентификация",
    ),
    "networkInsight": MessageLookupByLibrary.simpleMessage("Анализ сети"),
    "networkInsightDesc": MessageLookupByLibrary.simpleMessage(
      "Внешний IP, IPv4/IPv6 и доступность сервисов",
    ),
    ...
    "notYet": MessageLookupByLibrary.simpleMessage("Ещё не было"),
    ...
    "originalsOnly": MessageLookupByLibrary.simpleMessage(
    ...
    "profileDataUsedUp": MessageLookupByLibrary.simpleMessage(
      "Трафик исчерпан",
    ),
    "profileExpired": MessageLookupByLibrary.simpleMessage("Истёк"),
    "profileHasUpdate": MessageLookupByLibrary.simpleMessage(
      "Профиль был изменен. Хотите отключить автообновление?",
    ),
    "profileInUse": MessageLookupByLibrary.simpleMessage("Используется"),
    "profileNameNullValidationDesc": MessageLookupByLibrary.simpleMessage(
      "Пожалуйста, введите имя профиля",
    ),
    "profileUpdating": MessageLookupByLibrary.simpleMessage("Обновление…"),
    ...
    "publicIPv4": MessageLookupByLibrary.simpleMessage("Внешний IPv4"),
    "publicIPv6": MessageLookupByLibrary.simpleMessage("Внешний IPv6"),
    ...
    "serviceCheckPrivacyTip": MessageLookupByLibrary.simpleMessage(
      "Проверки обращаются к каждому сервису напрямую через текущий прокси. Данные профилей, подписок и журналов не передаются.",
    ),
    ...
    "stateConnecting": MessageLookupByLibrary.simpleMessage("Подключение…"),
    "stateDisconnecting": MessageLookupByLibrary.simpleMessage("Отключение…"),
    "stateNotConnected": MessageLookupByLibrary.simpleMessage("Не подключено"),
    "stateOff": MessageLookupByLibrary.simpleMessage("Выкл"),
    "stateOn": MessageLookupByLibrary.simpleMessage("Вкл"),
    "stateRunning": MessageLookupByLibrary.simpleMessage("Работает"),
    "stateStopped": MessageLookupByLibrary.simpleMessage("Остановлено"),
    "status": MessageLookupByLibrary.simpleMessage("Статус"),
    "statusAvailable": MessageLookupByLibrary.simpleMessage("Доступно"),
    "statusBlocked": MessageLookupByLibrary.simpleMessage("Заблокировано"),
    "statusChecking": MessageLookupByLibrary.simpleMessage("Проверка…"),
    "statusDesc": MessageLookupByLibrary.simpleMessage(
      "Системный DNS будет использоваться при выключении",
    ),
    "statusIpRestricted": MessageLookupByLibrary.simpleMessage("IP ограничен"),
    "statusLimited": MessageLookupByLibrary.simpleMessage("Ограничено"),
    "statusNetworkError": MessageLookupByLibrary.simpleMessage("Ошибка сети"),
    "statusNotChecked": MessageLookupByLibrary.simpleMessage("Не проверено"),
    "statusParseError": MessageLookupByLibrary.simpleMessage(
      "Неожиданный ответ",
    ),
    "statusRegional": MessageLookupByLibrary.simpleMessage("Региональный"),
    ...
    "systemResolver": MessageLookupByLibrary.simpleMessage(
      "Системный резолвер",
    ),
