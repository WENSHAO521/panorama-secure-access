...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(time) => "${time}에 확인";

  static String m1(time) => "${time} 동안 연결됨";

  static String m2(count) =>
      "${Intl.plural(count, one: '1일 전', other: '${count}일 전')}";

  static String m3(label) => "선택한 ${label}을(를) 삭제하시겠습니까?";

  static String m4(label) => "현재 ${label}을(를) 삭제하시겠습니까?";

  static String m5(label) => "${label} 세부 정보";

  static String m6(count) => "규칙 ${count}개";

  static String m7(label) => "${label}은(는) 비워둘 수 없습니다";

  static String m8(count) => "${count}개 항목";

  static String m9(label) => "현재 ${label}이(가) 이미 존재합니다";

  static String m10(date) => "${date} 만료";

  static String m11(name) => "${name} 건너뜀";

  static String m12(name) => "${name} 업데이트됨";

  static String m13(name) => "${name} 업데이트 중...";

  static String m14(count) =>
      "${Intl.plural(count, one: '1시간 전', other: '${count}시간 전')}";

  static String m15(count) => "${count}시간";

  static String m16(target) => "${target}은(는) 잘못된 정책입니다";

  static String m17(proxyName) => "${proxyName}은(는) 잘못된 프록시입니다";

  static String m18(providerName) => "${providerName}은(는) 잘못된 프록시 제공자입니다";

  static String m19(subRule) => "${subRule}은(는) 잘못된 SUB_RULE입니다";

  static String m20(reason) => "마지막 시도 실패: ${reason}";

  static String m21(time) => "마지막: ${time}";
  ...
  static String m28(label) => "${label}은(는) 1024에서 49151 사이여야 합니다";

  static String m29(count) => "${count}초";

  static String m30(count) => "${count}개 항목이 선택되었습니다";

  static String m31(available, total) => "${total}개 중 ${available}개 이용 가능";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "backupErrorFailed": MessageLookupByLibrary.simpleMessage("알 수 없는 오류"),
    "backupErrorNotFound": MessageLookupByLibrary.simpleMessage(
      "서버에 백업 파일이 없음",
    ),
    "backupErrorServer": MessageLookupByLibrary.simpleMessage("서버 오류"),
    "backupErrorUnauthorized": MessageLookupByLibrary.simpleMessage("로그인이 거부됨"),
    "backupErrorUnreachable": MessageLookupByLibrary.simpleMessage(
      "서버에 연결할 수 없음",
    ),
    ...
    "categoryConnectivity": MessageLookupByLibrary.simpleMessage("연결성"),
    "categoryRegional": MessageLookupByLibrary.simpleMessage("지역"),
    "categorySocial": MessageLookupByLibrary.simpleMessage("소셜"),
    "categoryStreaming": MessageLookupByLibrary.simpleMessage("스트리밍"),
    "checkAll": MessageLookupByLibrary.simpleMessage("모두 확인"),
    "checkService": MessageLookupByLibrary.simpleMessage("확인"),
    ...
    "comingSoon": MessageLookupByLibrary.simpleMessage("출시 예정"),
    ...
    "connectAction": MessageLookupByLibrary.simpleMessage("연결"),
    ...
    "connectionEthernet": MessageLookupByLibrary.simpleMessage("이더넷"),
    "connectionMobile": MessageLookupByLibrary.simpleMessage("모바일 데이터"),
    ...
    "currentNode": MessageLookupByLibrary.simpleMessage("노드"),
    ...
    "dashboardDesc": MessageLookupByLibrary.simpleMessage("이전 버전의 사용자 지정 위젯"),
    ...
    "davChecking": MessageLookupByLibrary.simpleMessage("확인 중…"),
    "davReachable": MessageLookupByLibrary.simpleMessage("연결 가능"),
    "davUnreachable": MessageLookupByLibrary.simpleMessage("연결할 수 없음"),
    "daysAgo": m2,
    ...
    "diagnostics": MessageLookupByLibrary.simpleMessage("진단"),
    ...
    "disconnectAction": MessageLookupByLibrary.simpleMessage("연결 해제"),
    ...
    "dnsConfigNote": MessageLookupByLibrary.simpleMessage(
      "코어가 사용하는 DNS 설정입니다. 실제로 응답하는 리졸버는 여기서 확인하지 않습니다.",
    ),
    "dnsConfiguredBy": MessageLookupByLibrary.simpleMessage("설정 출처"),
    "dnsDesc": MessageLookupByLibrary.simpleMessage("DNS 관련 설정을 업데이트합니다"),
    "dnsFromFallback": MessageLookupByLibrary.simpleMessage(
      "앱 DNS 설정과 시스템 리졸버 (프로필 DNS 꺼짐)",
    ),
    "dnsFromOverride": MessageLookupByLibrary.simpleMessage(
      "앱 DNS 설정 (DNS 재정의 켜짐)",
    ),
    "dnsFromProfile": MessageLookupByLibrary.simpleMessage("프로필"),
    ...
    "interfaces": MessageLookupByLibrary.simpleMessage("인터페이스"),
    ...
    "localAddresses": MessageLookupByLibrary.simpleMessage("로컬 주소"),
    ...
    "networkIdentity": MessageLookupByLibrary.simpleMessage("네트워크 정보"),
    "networkInsight": MessageLookupByLibrary.simpleMessage("네트워크 인사이트"),
    "networkInsightDesc": MessageLookupByLibrary.simpleMessage(
      "출구 IP, IPv4/IPv6 및 서비스 이용 가능 여부",
    ),
    ...
    "noExpiry": MessageLookupByLibrary.simpleMessage("만료 없음"),
    ...
    "notYet": MessageLookupByLibrary.simpleMessage("아직 없음"),
    ...
    "originalsOnly": MessageLookupByLibrary.simpleMessage("오리지널만"),
    ...
    "profileDataUsedUp": MessageLookupByLibrary.simpleMessage("데이터 소진"),
    "profileExpired": MessageLookupByLibrary.simpleMessage("만료됨"),
    "profileHasUpdate": MessageLookupByLibrary.simpleMessage(
      "프로필이 수정되었습니다. 자동 업데이트를 비활성화하시겠습니까?",
    ),
    "profileInUse": MessageLookupByLibrary.simpleMessage("사용 중"),
    "profileNameNullValidationDesc": MessageLookupByLibrary.simpleMessage(
      "프로필 이름을 입력해 주세요",
    ),
    "profileUpdating": MessageLookupByLibrary.simpleMessage("업데이트 중…"),
    ...
    "publicIPv4": MessageLookupByLibrary.simpleMessage("공인 IPv4"),
    "publicIPv6": MessageLookupByLibrary.simpleMessage("공인 IPv6"),
    ...
    "stateConnecting": MessageLookupByLibrary.simpleMessage("연결 중…"),
    "stateDisconnecting": MessageLookupByLibrary.simpleMessage("연결 해제 중…"),
    "stateNotConnected": MessageLookupByLibrary.simpleMessage("연결되지 않음"),
    "stateOff": MessageLookupByLibrary.simpleMessage("꺼짐"),
    "stateOn": MessageLookupByLibrary.simpleMessage("켜짐"),
    "stateRunning": MessageLookupByLibrary.simpleMessage("실행 중"),
    "stateStopped": MessageLookupByLibrary.simpleMessage("중지됨"),
    "status": MessageLookupByLibrary.simpleMessage("상태"),
    "statusAvailable": MessageLookupByLibrary.simpleMessage("이용 가능"),
    "statusBlocked": MessageLookupByLibrary.simpleMessage("차단됨"),
    "statusChecking": MessageLookupByLibrary.simpleMessage("확인 중…"),
    "statusDesc": MessageLookupByLibrary.simpleMessage("비활성화하면 시스템 DNS를 사용합니다"),
    "statusIpRestricted": MessageLookupByLibrary.simpleMessage("IP 제한"),
    "statusLimited": MessageLookupByLibrary.simpleMessage("제한됨"),
    "statusNetworkError": MessageLookupByLibrary.simpleMessage("네트워크 오류"),
    "statusNotChecked": MessageLookupByLibrary.simpleMessage("확인 안 함"),
    "statusParseError": MessageLookupByLibrary.simpleMessage("예상치 못한 응답"),
    "statusRegional": MessageLookupByLibrary.simpleMessage("지역 한정"),
    "statusUnsupportedRegion": MessageLookupByLibrary.simpleMessage(
      "지원되지 않는 지역",
    ),
    ...
    "systemResolver": MessageLookupByLibrary.simpleMessage("시스템 리졸버"),
