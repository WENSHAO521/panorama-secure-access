...
class _ProxiesStyleProps implements ProxiesStyleProps {
  const _ProxiesStyleProps({this.type = ProxiesType.tab, this.sortType = ProxiesSortType.none, this.layout = ProxiesLayout.standard, this.iconStyle = ProxiesIconStyle.standard, this.cardType = ProxyCardType.row});
...
mixin _$BackupHistory {
 ...
 DateTime? get localBackupAt; DateTime? get localRestoreAt; DateTime? get remoteBackupAt; DateTime? get remoteRestoreAt; BackupErrorKind? get remoteError; DateTime? get remoteErrorAt;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is BackupHistory&&(identical(other.localBackupAt, localBackupAt) || other.localBackupAt == localBackupAt)&&(identical(other.localRestoreAt, localRestoreAt) || other.localRestoreAt == localRestoreAt)&&(identical(other.remoteBackupAt, remoteBackupAt) || other.remoteBackupAt == remoteBackupAt)&&(identical(other.remoteRestoreAt, remoteRestoreAt) || other.remoteRestoreAt == remoteRestoreAt)&&(identical(other.remoteError, remoteError) || other.remoteError == remoteError)&&(identical(other.remoteErrorAt, remoteErrorAt) || other.remoteErrorAt == remoteErrorAt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,localBackupAt,localRestoreAt,remoteBackupAt,remoteRestoreAt,remoteError,remoteErrorAt);

@override
String toString() {
  return 'BackupHistory(localBackupAt: $localBackupAt, localRestoreAt: $localRestoreAt, remoteBackupAt: $remoteBackupAt, remoteRestoreAt: $remoteRestoreAt, remoteError: $remoteError, remoteErrorAt: $remoteErrorAt)';
}
...
@useResult
$Res call({
 DateTime? localBackupAt, DateTime? localRestoreAt, DateTime? remoteBackupAt, DateTime? remoteRestoreAt, BackupErrorKind? remoteError, DateTime? remoteErrorAt
});
...
/// Create a copy of BackupHistory
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? localBackupAt = freezed,Object? localRestoreAt = freezed,Object? remoteBackupAt = freezed,Object? remoteRestoreAt = freezed,Object? remoteError = freezed,Object? remoteErrorAt = freezed,}) {
  return _then(_self.copyWith(
localBackupAt: freezed == localBackupAt ? _self.localBackupAt : localBackupAt // ignore: cast_nullable_to_non_nullable
as DateTime?,localRestoreAt: freezed == localRestoreAt ? _self.localRestoreAt : localRestoreAt // ignore: cast_nullable_to_non_nullable
as DateTime?,remoteBackupAt: freezed == remoteBackupAt ? _self.remoteBackupAt : remoteBackupAt // ignore: cast_nullable_to_non_nullable
as DateTime?,remoteRestoreAt: freezed == remoteRestoreAt ? _self.remoteRestoreAt : remoteRestoreAt // ignore: cast_nullable_to_non_nullable
as DateTime?,remoteError: freezed == remoteError ? _self.remoteError : remoteError // ignore: cast_nullable_to_non_nullable
as BackupErrorKind?,remoteErrorAt: freezed == remoteErrorAt ? _self.remoteErrorAt : remoteErrorAt // ignore: cast_nullable_to_non_nullable
as DateTime?,
  ));
}
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _BackupHistory value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _BackupHistory() when $default != null:
return $default(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _BackupHistory value)  $default,){
final _that = this;
switch (_that) {
case _BackupHistory():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _BackupHistory value)?  $default,){
final _that = this;
switch (_that) {
case _BackupHistory() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( DateTime? localBackupAt,  DateTime? localRestoreAt,  DateTime? remoteBackupAt,  DateTime? remoteRestoreAt,  BackupErrorKind? remoteError,  DateTime? remoteErrorAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _BackupHistory() when $default != null:
return $default(_that.localBackupAt,_that.localRestoreAt,_that.remoteBackupAt,_that.remoteRestoreAt,_that.remoteError,_that.remoteErrorAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( DateTime? localBackupAt,  DateTime? localRestoreAt,  DateTime? remoteBackupAt,  DateTime? remoteRestoreAt,  BackupErrorKind? remoteError,  DateTime? remoteErrorAt)  $default,) {final _that = this;
switch (_that) {
case _BackupHistory():
return $default(_that.localBackupAt,_that.localRestoreAt,_that.remoteBackupAt,_that.remoteRestoreAt,_that.remoteError,_that.remoteErrorAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( DateTime? localBackupAt,  DateTime? localRestoreAt,  DateTime? remoteBackupAt,  DateTime? remoteRestoreAt,  BackupErrorKind? remoteError,  DateTime? remoteErrorAt)?  $default,) {final _that = this;
switch (_that) {
case _BackupHistory() when $default != null:
return $default(_that.localBackupAt,_that.localRestoreAt,_that.remoteBackupAt,_that.remoteRestoreAt,_that.remoteError,_that.remoteErrorAt);case _:
  return null;
...
class _BackupHistory implements BackupHistory {
  const _BackupHistory({this.localBackupAt, this.localRestoreAt, this.remoteBackupAt, this.remoteRestoreAt, this.remoteError, this.remoteErrorAt});
  factory _BackupHistory.fromJson(Map<String, dynamic> json) => _$BackupHistoryFromJson(json);

@override final  DateTime? localBackupAt;
@override final  DateTime? localRestoreAt;
@override final  DateTime? remoteBackupAt;
@override final  DateTime? remoteRestoreAt;
@override final  BackupErrorKind? remoteError;
@override final  DateTime? remoteErrorAt;
...
@override
Map<String, dynamic> toJson() {
  return _$BackupHistoryToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _BackupHistory&&(identical(other.localBackupAt, localBackupAt) || other.localBackupAt == localBackupAt)&&(identical(other.localRestoreAt, localRestoreAt) || other.localRestoreAt == localRestoreAt)&&(identical(other.remoteBackupAt, remoteBackupAt) || other.remoteBackupAt == remoteBackupAt)&&(identical(other.remoteRestoreAt, remoteRestoreAt) || other.remoteRestoreAt == remoteRestoreAt)&&(identical(other.remoteError, remoteError) || other.remoteError == remoteError)&&(identical(other.remoteErrorAt, remoteErrorAt) || other.remoteErrorAt == remoteErrorAt));
}
...
/// Create a copy of BackupHistory
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? localBackupAt = freezed,Object? localRestoreAt = freezed,Object? remoteBackupAt = freezed,Object? remoteRestoreAt = freezed,Object? remoteError = freezed,Object? remoteErrorAt = freezed,}) {
...
/// Create a copy of Config
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? currentProfileId = freezed,Object? overrideDns = null,Object? hotKeyActions = null,Object? appSettingProps = null,Object? davProps = freezed,Object? networkProps = null,Object? vpnProps = null,Object? themeProps = null,Object? proxiesStyleProps = null,Object? windowProps = null,Object? patchClashConfig = null,Object? excludeSSIDs = null,Object? backupHistory = null,}) {
  return _then(_self.copyWith(
...
as List<String>,backupHistory: null == backupHistory ? _self.backupHistory : backupHistory // ignore: cast_nullable_to_non_nullable
as BackupHistory,
  ));
}
/// Create a copy of Config
...
@override
@pragma('vm:prefer-inline')
$BackupHistoryCopyWith<$Res> get backupHistory {
  
  return $BackupHistoryCopyWith<$Res>(_self.backupHistory, (value) {
    return _then(_self.copyWith(backupHistory: value));
  });
}
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? currentProfileId,  bool overrideDns,  List<HotKeyAction> hotKeyActions, @JsonKey(fromJson: AppSettingProps.safeFromJson)  AppSettingProps appSettingProps,  DAVProps? davProps,  NetworkProps networkProps,  VpnProps vpnProps, @JsonKey(fromJson: ThemeProps.safeFromJson)  ThemeProps themeProps,  ProxiesStyleProps proxiesStyleProps,  WindowProps windowProps,  PatchClashConfig patchClashConfig,  List<String> excludeSSIDs,  BackupHistory backupHistory)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Config() when $default != null:
return $default(_that.currentProfileId,_that.overrideDns,_that.hotKeyActions,_that.appSettingProps,_that.davProps,_that.networkProps,_that.vpnProps,_that.themeProps,_that.proxiesStyleProps,_that.windowProps,_that.patchClashConfig,_that.excludeSSIDs,_that.backupHistory);case _:
  return orElse();
...
@override@JsonKey() final  BackupHistory backupHistory;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,currentProfileId,overrideDns,const DeepCollectionEquality().hash(_hotKeyActions),appSettingProps,davProps,networkProps,vpnProps,themeProps,proxiesStyleProps,windowProps,patchClashConfig,const DeepCollectionEquality().hash(_excludeSSIDs),backupHistory);
