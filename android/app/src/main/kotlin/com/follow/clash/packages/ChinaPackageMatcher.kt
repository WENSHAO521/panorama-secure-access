...
// Ported from FlClash (chen08209/FlClash, GPL-3.0),
// android/app/src/main/kotlin/com/follow/clash/packages/ChinaPackageMatcher.kt
// at v0.8.98. Same list and rules as the matcher that lived in AppPlugin,
// plus upstream's two false-positive fixes (com.mxtech, com.stubhub).
